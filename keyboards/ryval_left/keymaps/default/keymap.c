...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_SPC,  KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,
        KC_SPC,  KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,
        KC_SPC,  KC_CAPS,          KC_LALT, M(1),    KC_SPC
    ),
    [1] = LAYOUT(
        _______, KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC,
    ...
    [2] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______,
        _______, _______,          _______, _______, _______, _______, _______,
        _______, _______,          _______, _______, M(2)
    ),
